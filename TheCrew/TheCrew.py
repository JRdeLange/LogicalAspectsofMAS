...
def print_rules():
    ...
    print(
        "The cards are numbered 1 to 6. Cards 1 and 2 are of suit 1, cards 3 and 4 are of suit 2 and cards 5 and 6 are trump cards.")
    print("")
    print(
        "The game is played in rounds called tricks. In a trick each player plays one card. The first card played determines the suit of the trick.")
    ...
    print(
        "The winner of a trick gets the cards played during that trick in their won cards pile. This is how the mission can be accomplished.")
    print("")
    print(
        "At any moment a player can choose to communicate one of the cards in their hand to the other players. Each player can only do this once during the game.")
    print(
        "This program assists by keeping track of the cards communicated and showing the player which facts everyone should be aware of.")
    print(
        "During play the program will also tell the player which tricks they should know can happen during this round.")
    print("It will also say if any of those will result in accomplishing the mission.")
    print("")
    print("minor note: each turn the hand cards of the players are printed.")
    print(
        "This is to make it easier for the user to create specific situations and this is not considered to be known by the individual players.")
    print("")
...
def game_loop(game):
    ...
    while mission_ongoing:
        ...
        action = input(
            "Which action do you wish to perform? (type \"play\" to play a card, \"com\" to communicate a card or \"quit\" to quit)\n")
        print("")
